...
$string['dashboardupdatecount'] = 'to update';
...
// Updates: move activities to their project's current version.
$string['updates'] = 'Updates';
$string['updates_desc'] = 'Activities using an older version of their project. Select them to move them to the current version.';
$string['updatesapply'] = 'Update selected activities';
$string['updatesclearfilters'] = 'Clear filters';
$string['updatesconfirm'] = 'Update the selected activities to their project\'s current version? Learner progress and activity names are kept.';
$string['updatesfailed'] = 'Could not update {$a->activityname} in {$a->coursename}: {$a->message}';
$string['updatesnomatch'] = 'No activities that need updating match these filters.';
$string['updatesnone'] = 'Every managed activity is on its project\'s current version.';
$string['updatesnopermission'] = 'You can see which activities need updating, but applying updates needs permission to deploy RapidCMI5 content.';
$string['updatesrevisionmissing'] = 'The content library revision for this project\'s current version is missing, so these activities cannot be updated. Upload a new version first.';
$string['updatesselect'] = 'Select';
$string['updatesselectall'] = 'Select all';
$string['updatesskipped'] = 'Activities skipped because they were already on the current version: {$a}';
$string['updatesupdated'] = 'Activities updated to their project\'s current version: {$a}';
$string['updatesviewproject'] = 'View project';
$string['projectupdatesbanner'] = 'Activities using an older version of this project: {$a}';
$string['reviewupdates'] = 'Review in Updates';
